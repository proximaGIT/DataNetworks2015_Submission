...
function respondtoChatErrors(lines) {
    ...
    if (reply[0] == "OKAY" && reply[1] == msgID) {
        ...
        addUser(user_arrv_num, lines[1].trim(), lines[2].trim());
...
function main() {
    ...
    document.getElementById("serverInput").value = "localhost";
}
